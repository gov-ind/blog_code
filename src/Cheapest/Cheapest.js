  ...
  render() {
    return (
        <div className='content'>
          ...
          <p><b>Description. </b>This was a maze-solving challenge in TJCTF that could be solved by using Djikstra's algorithm. As someone who didn't graduate with a computer science degree, I didn't know much about the relation between Djikstra's algorithm and a Breadth-First Search, so I thought it would be a good idea to note down the connection between the two. In the challenge, we're given up to 20 nodes and the distances between each pair of nodes. There are a total of 50 rounds, and for each round, the aim is to find the shortest path between node 0 and node 20.
          </p>
